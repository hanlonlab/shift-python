...
- Configuring Docker as a remote interpreter:
    ...
    - Follow the steps in the `Configuring Docker as a remote interpreter` session of [guide](https://www.jetbrains.com/help/pycharm/using-docker-as-a-remote-interpreter.html).
