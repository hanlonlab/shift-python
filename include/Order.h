...
void bindPython(py::module& m)
{
    ...
    ORDER //! Bind property
        ...
        .def_property("executedSize", &shift::Order::getExecutedSize, &shift::Order::setExecutedSize, py::return_value_policy::reference)
        .def_property("price", &shift::Order::getPrice, &shift::Order::setPrice, py::return_value_policy::reference)
        .def_property("executedPrice", &shift::Order::getExecutedPrice, &shift::Order::setExecutedPrice, py::return_value_policy::reference)
