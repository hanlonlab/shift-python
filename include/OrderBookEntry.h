...
void bindPython(py::module& m)
{
    ...
    ORDER_BOOK_ENTRY //! Bind constructor
        .def(py::init<char, std::string, double, double, std::string, double>(), py::arg("type"), py::arg("symbol"), py::arg("price"), py::arg("size"), py::arg("destination"), py::arg("time"));
    ORDER_BOOK_ENTRY //! Bind property
        .def_property("type", &shift::OrderBookEntry::getType, &shift::OrderBookEntry::setType, py::return_value_policy::reference)
