...
void bindPython(py::module& m)
{
    ...
    PORTFOLIO_SUMMARY //! Bind constructor
        .def(py::init<double, int, double, double>(), py::arg("totalBP"), py::arg("totalShares"), py::arg("totalPL"), py::arg("totalRealizedPL"));
    ...
    PORTFOLIO_SUMMARY //! Bind property
        ...
        .def_property("totalPL", &shift::PortfolioSummary::getTotalPL, &shift::PortfolioSummary::setTotalPL, py::return_value_policy::reference)
